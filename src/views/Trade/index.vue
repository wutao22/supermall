<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(item, index) in TradeList.detailArrayList" :key="item.skuId">
          <li>
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea placeholder="建议留言前先与商家沟通确认" class="remarks-cont" v-model="mark"></textarea>
...
import {mapState} from 'vuex'
  export default {
    ...
    computed: {
      ...mapState({
        TradeList:(state) => state.trade.tradeInfo,
      })
    }
  }
</script>
