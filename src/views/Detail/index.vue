        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(sAttrValue, index) in skuSaleAttrValueList" :key="sAttrValue.id">
                <dt class="title">{{sAttrValue.saleAttrName}}</dt>
                <dd changepirce="0" class="active">{{sAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
